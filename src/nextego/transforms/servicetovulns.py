...
from common.reportparser import nexposeServiceTests, nexposeVulns, reportChecker
from canari.framework import configure
from canari.config import config
from common.entities import Service, NexposeVulnerability
...
@configure(
	...
	description='Outputs Vulnerabilities',
	uuids=[ 'nextego.v2.NexposeServicetoVuln' ],
...
def dotransform(request, response):
	...
	for dic in nexposeServiceTests(reporto):
